...
# Build Email for Male ----------------------------------------------------
getReceiverFirstName <- function(data_frame,male_user_id){
  firstName <- data_frame %>%
    filter(user_id==enter_user_id) %>%
    select(demo_first_name)
  return(firstName)
}
partnerFirstName <- getFirstName(user_table,user_table$user_id[1])


getPartnerFirstName <- function(data_frame,partner_user_id){
 firstName <- data_frame %>%
    filter(user_id==partner_user_id) %>%
    pull(demo_first_name)
 return(firstName)
}

partnerFirstName <- getPartnerFirstName(user_table,'uid00000001')


getScore <- function(data_frame,male_user_id){
  matchScore <- data_frame %>%
    filter(user_id==male_user_id) %>%
    pull(match_percentage_male)
  return(matchScore)
}

recieverScore <- getScore(potential_matches,male_user_id)

yourScore <- 89.9 
matchFirstName <- 'Dave'

emailBody <- gm_html_body('<html xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraph.org/schema/"><head>
        
<meta property="og:title" content="You Matches are Coming Soon.">
...
<meta name="referrer" content="origin">        
        ...
        <title>You Matches are Coming Soon.</title>
...
}</style><!--[if !mso]><!--><link href="https://fonts.googleapis.com/css?family=Roboto:400,400i,700,700i" rel="stylesheet"><!--<![endif]-->                 <link rel="stylesheet" href="https://us19.campaign-archive.com/css/archivebar-desktop.css" mc:nocompile="">  </head> <body id="archivebody" style="height: 100%;margin: 0;padding: 0;width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #fffff7;"> 
        
        <!---->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Thanks for signing up for PeopleLikeYou—your matches are coming soon.</span><!--<![endif]-->
        <!---->
        <center>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                            ...
                            <h1 style="display: block;margin: 0;padding: 0;color: #202020;font-family: \'Roboto\', \'Helvetica Neue\', Helvetica, Arial, sans-serif;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;">Welcome!</h1>
...
<br>
We\'re finalizing&nbsp;the matching algorithm and&nbsp;expect to start sending the first round of potential matches on Monday via email.<br>
      <br>
      When you receive a match, just let us know whether you\'d like to be connected with the person and we\'ll do the rest.<br>
      <br>
      <span style="color:#FF0000"><strong>Very importantly</strong></span>, if you know anyone else&nbsp;who you\'re&nbsp;surprised is still single (and think would benefit from meeting some great LDS people)&nbsp;please share <a href="http://people-like-you.com/" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #007C89;font-weight: normal;text-decoration: underline;">the survey with them</a>, too.&nbsp;<br>
<br>
Our long-term&nbsp;goal is to help you find a great partner, but to start we just hope you meet some really cool people while on lockdown.<br>
<br>
If you have any questions check out&nbsp;<a href="http://people-like-you.com/" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #007C89;font-weight: normal;text-decoration: underline;">http://people-like-you.com/</a>&nbsp;or feel free to&nbsp;reach out to <a href="mailto:team@people-like-you.com" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #007C89;font-weight: normal;text-decoration: underline;">team@people-like-you.com</a>—we\'d love to hear from you.<br>
      <br>
      Take care and talk soon.<br>
      - The Team at PeopleLikeYou</p>
